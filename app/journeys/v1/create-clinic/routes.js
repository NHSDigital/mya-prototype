...
// Variant views live in create-clinic/{single,series}/; the single/series choice
// is data-driven (clinicFlowType) so it is not part of the URL.
...
router.all('/site/:id/clinics/type-of-clinc', (req, res) => {
  ...
  res.render('create-clinic/type-of-clinc');
});
...
router.all('/site/:id/clinics/details', (req, res) => {
  ...
  return res.render(`create-clinic/${flowType}/details`);
});
...
router.all('/site/:id/clinics/days', (req, res) => {
  ...
  return res.render('create-clinic/series/days');
});
...
router.all('/site/:id/clinics/clinic-times', (req, res) => {
  ...
  return res.render(`create-clinic/${flowType}/clinic-times`, {
...
router.all('/site/:id/clinics/services', (req, res) => {
  ...
  res.render(`create-clinic/${flowType}/services`, {
...
router.all('/site/:id/clinics/clinic-closures', (req, res) => {
  ...
  if (req.method === 'POST') {
    ...
    return res.render('create-clinic/series/clinic-closures', {
      closures,
      addAnother,
      errors: {
...
router.all('/site/:id/clinics/clinic-closures/add', (req, res) => {
  ...
  if (req.method === 'POST') {
    ...
    if (closureErrors) {
      return res.render('create-clinic/series/clinic-closures-form', {
        mode: 'add',
...
router.all('/site/:id/clinics/clinic-closures/:index/remove', (req, res) => {
  ...
  if (req.method === 'POST') {
    ...
    return res.render('create-clinic/series/clinic-closures-remove', {
      index,
      closure: current,
      confirmRemove,
      errors: {
...
router.all('/site/:id/clinics/check-answers', (req, res) => {
  ...
  res.render(`create-clinic/${flowType}/check-answers`);
});
...
router.get('/site/:id/clinics/success', (req, res) => {
  ...
  res.render(`create-clinic/${flowType}/success`);
});
