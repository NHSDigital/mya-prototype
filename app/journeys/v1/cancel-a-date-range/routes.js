// Journey: cancel a date range
// URL base: /site/:id/cancel-availability/*  (folder name differs from URL segment)
// Per-site context (req.site_id, res.locals.dailyAvailability) is provided centrally
// by app/journeys/_shared/site-context.js.
...
router.get('/site/:id/cancel-availability/dates', (req, res) => {
  res.render('cancel-a-date-range/dates');
});
...
router.all('/site/:id/cancel-availability/sessions-and-bookings', (req, res) => {
  ...
  res.render('cancel-a-date-range/sessions-and-bookings', {
    startDate, 
    endDate,
    affectedSessions,
    affectedBookings,
...
router.all('/site/:id/cancel-availability/check-answers', (req, res) => {
  ...
  res.render('cancel-a-date-range/check-answers', { startDate, endDate });
});

router.all('/site/:id/cancel-availability/success', (req, res) => {
  const { startDate, endDate } = getStartAndEndDates(req.session.data);

  res.render('cancel-a-date-range/success', { startDate, endDate });
});
