...
// Views live in change-clinic/{edit,single,series}/. The single/series split is
// data-driven (state.draft.type) and therefore cannot appear in the URL.
...
router.get('/site/:id/clinics/edit/:sessionId', (req, res) => {
  ...
  return res.render('change-clinic/edit/summary-parent', {
    draft: state.draft,
...
// Cancel-clinic journey moved to app/journeys/cancel-clinic/routes.js
...
router.all('/site/:id/clinics/edit/:sessionId/details', (req, res) => {
  ...
  return res.render(`change-clinic/${state.draft.type === 'Clinic series' ? 'series' : 'single'}/details`, {
...
router.all('/site/:id/clinics/edit/:sessionId/days', (req, res) => {
  ...
  setEditTemplateData(res, data, state);
  return res.render('change-clinic/series/days', {
    backUrl: editSummaryPath(req.site_id, req.params.sessionId),
...
router.all('/site/:id/clinics/edit/:sessionId/clinic-times', (req, res) => {
  ...
  setEditTemplateData(res, data, state);
  return res.render(`change-clinic/${state.draft.type === 'Clinic series' ? 'series' : 'single'}/clinic-times`, {
    backUrl: editSummaryPath(req.site_id, req.params.sessionId),
...
router.all('/site/:id/clinics/edit/:sessionId/services', (req, res) => {
  ...
  setEditTemplateData(res, data, state);
  return res.render(`change-clinic/${state.draft.type === 'Clinic series' ? 'series' : 'single'}/services`, {
    backUrl: editSummaryPath(req.site_id, req.params.sessionId),
...
router.all('/site/:id/clinics/edit/:sessionId/clinic-closures', (req, res) => {
  ...
  if (req.method === 'POST') {
    ...
    return res.render('change-clinic/series/clinic-closures', {
      backUrl: editSummaryPath(req.site_id, req.params.sessionId),
...
router.all('/site/:id/clinics/edit/:sessionId/clinic-closures/add', (req, res) => {
  ...
  if (req.method === 'POST') {
    ...
    if (closureErrors) {
      return res.render('change-clinic/series/clinic-closures-form', {
...
router.all('/site/:id/clinics/edit/:sessionId/clinic-closures/:index/remove', (req, res) => {
  ...
  if (req.method === 'POST') {
    ...
    return res.render('change-clinic/series/clinic-closures-remove', {
      backUrl: editStepPath(req.site_id, req.params.sessionId, 'clinic-closures'),
...
router.all('/site/:id/clinics/edit/:sessionId/affected-bookings', (req, res) => {
  ...
  return res.render('change-clinic/edit/affected-bookings', {
    sessionId: req.params.sessionId,
...
router.all('/site/:id/clinics/edit/:sessionId/check-answers', (req, res) => {
  ...
  return res.render('change-clinic/edit/check-answers', {
    sessionId: req.params.sessionId,
    isSeries: state.draft.type === 'Clinic series',
...
router.get('/site/:id/clinics/edit/:sessionId/success', (req, res) => {
  ...
  return res.render('change-clinic/edit/success', {
    sessionId: req.params.sessionId,
