...
2. Capturing screenshots into the documentation screenshot folder.
3. Validating that step variants still have manifest coverage.

This reduces drift between route logic, screenshots, and documentation.
...
- step coverage for mapped variant ids
